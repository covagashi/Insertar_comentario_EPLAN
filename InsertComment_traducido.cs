...
//
// Copyright by Frank Schöneck, 2013-2015
// letzte Änderung:
...
// 
// V2.0.0, Español, 07.11.2017, Creado por Frank Schönec y traducido por covagashi, Funciona completamente en Eplan P8 2.7
...
public partial class frmInsertKommentar : System.Windows.Forms.Form
{
	...
	private void InitializeComponent()
	{
			...
			this.btnAbbrechen.Text = "Cancelar";
			...
			this.tabKommentar.Text = "Comentar";
			// 
			// cBStatus
			// 
	...
	//{
	//	AddDialogInsertCommentMenuItem();
	//}
	...
	//{
	//	RemoveDialogInsertCommentMenuItem();
	//}
	...
	//private void RemoveDialogInsertCommentMenuItem()
	//{
	//	//Menüeintrag
	//	Eplan.EplApi.Gui.Menu oMenu = new Eplan.EplApi.Gui.Menu();
	//	oMenu.RemoveMenuItem("Kommentar einfügen", "DialogInsertComment");
		
	//	//Kontextmenü Kommentare-Navigator
	//	Eplan.EplApi.Gui.ContextMenu oContextMenu = new Eplan.EplApi.Gui.ContextMenu();
	//	//Kontextmenü Kommentare-Navigator, Reiter Baum
	//	Eplan.EplApi.Gui.ContextMenuLocation oLocation = new Eplan.EplApi.Gui.ContextMenuLocation("XPdfCommentDlgTree", "1032");
	//	oContextMenu.RemoveMenuItem(oLocation, "Kommentar einfügen", "DialogInsertComment", true, false);
	//	//Kontextmenü Kommentare-Navigator, Reiter Liste
	//	Eplan.EplApi.Gui.ContextMenuLocation oLocationList = new Eplan.EplApi.Gui.ContextMenuLocation("XPdfCommentDlgList", "1038");
	//	oContextMenu.RemoveMenuItem(oLocationList, "Kommentar einfügen", "DialogInsertComment", true, false);
	//}
